...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_CEAddressString = 16,           /* CEAddressString  */
  YYSYMBOL_binaryExpr = 17,                /* binaryExpr  */
  YYSYMBOL_unaryExpr = 18,                 /* unaryExpr  */
  YYSYMBOL_atom = 19,                      /* atom  */
  YYSYMBOL_identList = 20                  /* identList  */
};
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, BaseNode** result)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (yylocationp);
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, BaseNode** result)
{
  YYUSE (yyvaluep);
  YYUSE (yylocationp);
  YYUSE (result);
...
yyreduce:
  ...
  case 2: /* CEAddressString: binaryExpr $end  */
                                  { *result = (yyvsp[-1].node); (yyval.node) = (yyvsp[-1].node); }
    break;
  ...
  case 5: /* binaryExpr: binaryExpr "+" binaryExpr  */
                             { (yyval.node) = new BinaryNode((yyvsp[-2].node), PLUS, (yyvsp[0].node)); }
    break;

  case 6: /* binaryExpr: binaryExpr "-" binaryExpr  */
                              { (yyval.node) = new BinaryNode((yyvsp[-2].node), MINUS, (yyvsp[0].node)); }
    break;

  case 7: /* binaryExpr: binaryExpr "*" binaryExpr  */
                            { (yyval.node) = new BinaryNode((yyvsp[-2].node), MUL, (yyvsp[0].node)); }
    break;

  case 8: /* binaryExpr: binaryExpr "**" binaryExpr  */
                            { (yyval.node) = new BinaryNode((yyvsp[-2].node), POW, (yyvsp[0].node)); }
    break;

  case 9: /* unaryExpr: "+" atom  */
                     { (yyval.node) = new UnaryNode(PLUS, (yyvsp[0].node)); }
    break;

  case 10: /* unaryExpr: "-" atom  */
             { (yyval.node) = new UnaryNode(MINUS, (yyvsp[0].node)); }
    break;

  case 11: /* atom: "hex"  */
                { (yyval.node) = new HexNode((yyvsp[0].text)); }
    break;
  ...
  case 13: /* atom: "[" binaryExpr "]"  */
                             { (yyval.node) = new PointerNode((yyvsp[-1].node)); }
    break;

  case 14: /* atom: identList  */
                { (yyval.node) = new IdentsNode((yyvsp[0].idents)); }
    break;

  case 15: /* identList: "ident"  */
                 { (yyval.idents) = new std::vector<std::string*>(); (yyval.idents)->push_back((yyvsp[0].text)); }
    break;

  case 16: /* identList: identList "." "ident"  */
                        { (yyval.idents) = (yyvsp[-2].idents); (yyval.idents)->push_back((yyvsp[0].text)); }
    break;
