...
{
  nm_init;
  nm_ret(ajanuw::Mem::VAManage::size_);
}
Napi::Value VAManage::GetMemory(const Napi::CallbackInfo& info)
{
  nm_init;
  nm_ret((uintptr_t)ajanuw::Mem::VAManage::memory_);
}
Napi::Value VAManage::GetPosition(const Napi::CallbackInfo& info)
{
  nm_init;
  nm_ret((uintptr_t)ajanuw::Mem::VAManage::position_);
}
...
{
  nm_init;
  nm_ret((uintptr_t)ajanuw::Mem::VAManage::ptr_());
}
